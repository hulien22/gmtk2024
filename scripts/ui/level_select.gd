...
func PlayEnterLevelAnim():
	...
	tween.tween_property(%LittleGuy, "position", Vector2(0, 100), 1.0).set_ease(Tween.EASE_OUT)
	tween.parallel().tween_property(%LittleGuy, "scale", Vector2(0.5, 0.5), 1.0).set_ease(Tween.EASE_OUT)
	tween.tween_property(%LittleGuy, "position", Vector2(0, 200), 1.0).set_ease(Tween.EASE_OUT)
	tween.parallel().tween_property(%LittleGuy, "scale", Vector2(0.001,0.001), 1.0).set_ease(Tween.EASE_IN)
...
func PlayLeaveLevelAnim():
	...
	tween.tween_property(%LittleGuy, "position", Vector2(0, 100), 1.0).set_ease(Tween.EASE_OUT)
	tween.parallel().tween_property(%LittleGuy, "scale", Vector2(0.5, 0.5), 1.0).set_ease(Tween.EASE_OUT)
	tween.tween_property(%LittleGuy, "position", Vector2(0, 0), 1.0).set_ease(Tween.EASE_OUT)
	tween.parallel().tween_property(%LittleGuy, "scale", Vector2(0.001,0.001), 1.0).set_ease(Tween.EASE_IN)
